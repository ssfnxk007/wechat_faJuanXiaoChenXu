...
const navGroups = [
  ...
  { label: '系统权限', items: [{ to: '/admin-users', label: '权限管理', icon: 'admins', iconText: 'AU' }, { to: '/admin-roles', label: '角色管理', icon: 'roles', iconText: 'AR' }, { to: '/admin-menus', label: '菜单管理', icon: 'menus', iconText: 'AM' }] },
]
